<template>
  <the-footer
    ...
    :secondary-nav="footerSecondaryNav"
    :tertiary-nav="footerTertiaryNav"
    subheader1="About Us"
  >
...
export default {
  ...
  computed: {
    ...mapState('global', {
      footerSecondaryNav: state => state.footerSecondaryNav,
      footerTertiaryNav: state => state.footerTertiaryNav
    })
  }
}
</script>
